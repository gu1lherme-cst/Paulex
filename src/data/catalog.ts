import type { Category, Product, Cupom } from "../types";

/* ============================================================
   Configuração da loja
   ============================================================ */
export const WHATSAPP_NUMBER = "5521987578187";
export const FRETE_GRATIS_MIN = 99;
export const ATACADO_MIN = 12;
export const ATACADO_DESCONTO_PADRAO = 15;

/* Login com Google (opcional): cole o client id para habilitar. */
...
export const CATEGORIES: Category[] = [
  {
    ...
    icon: '<path d="M4 20l1.5-5L16 4.5l3.5 3.5L9 18.5 4 20z"/><path d="M13.5 7l3.5 3.5"/>',
  },
  {
    id: "utilidades",
    nome: "Utilidades",
    desc: "Produtos para o dia a dia e organização",
    icon: '<path d="M4 8l8-4 8 4v9l-8 4-8-4V8z"/><path d="M4 8l8 4 8-4M12 12v9"/>',
  },
  {
    id: "descartaveis",
    nome: "Descartáveis",
    desc: "Copos, pratos, talheres e embalagens",
    icon: '<path d="M7 4h10l-1.5 16h-7L7 4z"/><path d="M7.8 9h8.4"/>',
  },
  {
    id: "brinquedos",
    nome: "Brinquedos",
    desc: "Diversão para todas as idades",
    icon: '<rect x="4" y="12.5" width="7" height="7" rx="1"/><rect x="13" y="12.5" width="7" height="7" rx="1"/><rect x="8.5" y="4" width="7" height="7" rx="1"/>',
  },
  {
    id: "informatica",
    nome: "Informática",
    desc: "Acessórios, periféricos e muito mais",
    icon: '<rect x="5" y="5" width="14" height="9" rx="1.5"/><path d="M3 18h18l-2-4H5l-2 4z"/>',
  },
  {
    id: "cosmeticos",
    nome: "Cosméticos",
    desc: "Beleza e cuidados pessoais",
    icon: '<path d="M10 3h4v3h-4z"/><rect x="7.5" y="6" width="9" height="14" rx="3"/><path d="M10 11h4"/>',
  },
];

/* ilustração duotone azul Paulex */
const art = (inner: string) => inner;

export const PRODUCTS: Product[] = [
  /* ---------- Papelaria ---------- */
  {
    id: "caneta-bic",
    nome: "Caneta BIC Cristal Azul",
    unidade: "Unidade",
    preco: 1.2,
    cat: "papelaria",
    ...
    specs: [
      ...
      ["Ponta", "Média 1.0 mm"],
      ["Marca", "BIC"],
      ["Rendimento", "Até 2 km de escrita"],
    ],
    ...
    maisVendido: true,
    tiers: [
      { de: 1, ate: 11, preco: 1.2, off: null },
  ...
  {
    id: "papel-chamex",
    nome: "Papel Sulfite A4 Chamex 500 folhas",
    unidade: "Pacote",
    preco: 27.9,
    cat: "papelaria",
  ...
  {
    id: "tesoura",
    nome: "Tesoura Multiuso Inox 13cm",
    unidade: "Unidade",
    preco: 7.9,
    precoAntigo: 11.9,
    cat: "utilidades",
  ...
  },
  {
    ...
    specs: [
      ["Capacidade", "1 litro"],
      ["Material", "Aço inox"],
      ["Conserva quente", "12 horas"],
      ["Conserva frio", "24 horas"],
    ],
  ...
  },
  {
    ...
    nome: "Caixa Organizadora 20L com Tampa",
    unidade: "Unidade",
    preco: 29.9,
    precoAntigo: 36.9,
    cat: "utilidades",
  ...
  {
    id: "copo-200",
    nome: "Copo Descartável 200ml c/ 100",
    unidade: "Pacote",
    preco: 6.9,
    cat: "descartaveis",
  ...
  {
    id: "kit-talheres",
    nome: "Kit Talheres Descartáveis c/ 50",
    unidade: "Pacote",
    preco: 9.9,
    cat: "descartaveis",
  ...
  /* ---------- Brinquedos ---------- */
  {
    ...
    nome: "Carrinho Infantil Roda Livre",
    unidade: "Unidade",
    preco: 24.9,
    cat: "brinquedos",
  ...
  {
    id: "boneca-fashion",
    nome: "Boneca Fashion com Acessórios",
    unidade: "Unidade",
    preco: 39.9,
    precoAntigo: 49.9,
    cat: "brinquedos",
  ...
  {
    id: "jogo-educativo",
    nome: "Jogo Educativo de Encaixe",
    unidade: "Unidade",
    preco: 34.9,
    cat: "brinquedos",
  ...
  {
    id: "fone-p2",
    nome: "Fone de Ouvido P2 com Microfone",
    unidade: "Unidade",
    preco: 19.9,
    cat: "informatica",
  ...
  {
    id: "shampoo",
    nome: "Shampoo Hidratação Intensa 350ml",
    unidade: "Unidade",
    preco: 16.9,
    cat: "cosmeticos",
    ...
    specs: [
      ["Conteúdo", "350 ml"],
      ["Ativos", "Queratina e argan"],
      ["Tipo", "Todos os cabelos"],
    ],
  ...
  {
    id: "hidratante",
    nome: "Hidratante Corporal 400ml",
    unidade: "Unidade",
    preco: 18.9,
    precoAntigo: 24.9,
    cat: "cosmeticos",
  ...
  },
  {
    ...
    specs: [
      ["Conteúdo", "100 ml"],
      ["Família olfativa", "Amadeirada cítrica"],
      ["Fixação", "8 horas"],
    ],
